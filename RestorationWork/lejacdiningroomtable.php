...
<table width="100%">	
	<tr>
		<td align=center class="lejacHeader">Dining Room Table Restoration</td> 
	</tr>
			...
			<table valign="top">
				<tr>
					<td align="left" valign="top"><a href="#" 
                        onmouseover="Tip('<center> <img src=\'<?php print $productDir; ?>images/dinetbl1.bmp\' width=\'500\'> <br>')" 
                        onmouseout="UnTip()"  OnClick="(PopUP('pulejacsingleslide.php?filename=<?php print $productDir; ?>images/dinetbl1.bmp', 'pic', 600, 650, 1))">
                        <img  height=145 width=139 align="left" border="0" src="<?php print $productDir; ?>images/dinetbl1.bmp"></a></td>
					<td align="left" width=5>&nbsp;</td>
					<td align="left" valign="top"><a href="#" 
                        onmouseover="Tip('<center> <img src=\'<?php print $productDir; ?>images/dinetbl2.bmp\' width=\'500\'> <br>')" 
                        onmouseout="UnTip()"  OnClick="(PopUP('pulejacsingleslide.php?filename=<?php print $productDir; ?>images/dinetbl2.bmp', 'pic', 600, 650, 1))">
                        <img  height=145 width=139 align="left" border="0" src="<?php print $productDir; ?>images/dinetbl2.bmp"></a></td>
				</tr>
				<tr>
					<td align="left" width=5>&nbsp;</td>
				</tr>		
				<tr>
					<td align="left" valign="top"><a href="#" 
                        onmouseover="Tip('<center> <img src=\'<?php print $productDir; ?>images/dinetbl3.bmp\' width=\'500\'> <br>')" 
                        onmouseout="UnTip()"  OnClick="(PopUP('pulejacsingleslide.php?filename=<?php print $productDir; ?>images/dinetbl3.bmp', 'pic', 600, 650, 1))">
                        <img  height=139 width=139 align="left" border="0" src="<?php print $productDir; ?>images/dinetbl3.bmp"></a></td>
					<td align="left" width=5>&nbsp;</td>
					<td align="left" valign="top"><a href="#" 
                        onmouseover="Tip('<center> <img src=\'<?php print $productDir; ?>images/dinetbl4.bmp\' width=\'500\'> <br>')" 
                        onmouseout="UnTip()"  OnClick="(PopUP('pulejacsingleslide.php?filename=<?php print $productDir; ?>images/dinetbl4.bmp', 'pic', 600, 650, 1))">
                        <img  height=139 width=139 align="left" border="0" src="<?php print $productDir; ?>images/dinetbl4.bmp"></a></td>
				</tr>	
			</table>
		</td>	
		<td align="left" width=5>&nbsp;</td>
