...
// Set special globals.
//----------------------------------------------------------------------------------------------------------
$module = 'puWWBsingleslide.php';


require ('lejacGLOBAL.php');

require ('lejacInit.php');

require ('lejacfuncs.php');
...
<?php require ("lejacStyleSheet.css"); ?>
...
<?php require ("javascript/lejacJavaScript.js"); ?>
</script>
</head>
...
<center>
<form action="pulejacsingleslide.php" method=get>
